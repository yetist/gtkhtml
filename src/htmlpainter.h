 ...
 * Font handling. 
 */
void          html_painter_set_font_style  (HTMLPainter *p, HTMLFontStyle f);
HTMLFontStyle html_painter_get_font_style  (HTMLPainter *p);
guint         html_painter_calc_ascent     (HTMLPainter *p, HTMLFontStyle f);
guint         html_painter_calc_descent    (HTMLPainter *p, HTMLFontStyle f);
guint         html_painter_calc_text_width (HTMLPainter *p, const gchar *text, guint len,
					    HTMLFontStyle font_style);

/*
 * The actual paint operations
 */
void         html_painter_set_pen      (HTMLPainter *painter, const GdkColor *color);
